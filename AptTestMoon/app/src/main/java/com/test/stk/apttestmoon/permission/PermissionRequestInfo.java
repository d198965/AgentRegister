...
public class PermissionRequestInfo {
	...
	public PermissionRequestInfo(Context context,
								 PermissionCheckHelper.PermissionCallbackListener listener, int requestCode,
								 String[] permissionArray, String[] messageArray) {
	...
	private void initMap(){
	        permissionResultMap = new HashMap<String, Integer>();
	...
	public void setListener(PermissionCheckHelper.PermissionCallbackListener listener) {
		this.listener = listener;
	}
	...
	public String[] getRequestPermissions() {
		...
		if (permissionResultMap != null && count > 0) {
			permissions = permissionResultMap.keySet().toArray(
					new String[count]);
		}
		return permissions;
	}
	...
	public int[] getRequestResults() {
		...
		if (permissionResultMap != null && count > 0) {
			Integer[] results = permissionResultMap.values().toArray(
					new Integer[count]);
